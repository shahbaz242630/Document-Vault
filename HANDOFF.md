...
- Active branch: `codex/claimant-retrieval-suspension-expiry`; Slice 4H is complete locally on top of Slice 4G `83d1452`, Slice 4F `79a1d94`, Slice 4E `5122c6f`, Slice 4D `f0195fe`, Slice 4C `ef97a64`, Slice 4B `8d9d195`, and the earlier claimant checkpoints.
...
1. Begin Phase 4 Slice 4I with an immutable-false, runtime-disconnected native local-export contract. Require explicit claimant action and exact completed local-open authority; keep plaintext inside the native boundary, return only a value-free export receipt to JavaScript/server code, and keep closure false.
2. Keep Slice 1G/1H/1I/1J/2A/2B/2C/2D/2E/2F/2G/2H/2I/2J/3A/3B/3C/3D/3E/3F/3G/4A/4B/4C/4D/4E/4F/4G/4H hard-disabled and concealed, unmounted, or disconnected from normal app requests. Do not deploy the local claimant/Storage migrations or enable a claimant capability.
...
4. In Slice 4I, treat Shahbaz Malik as the accountable human test reviewer and Codex only as a non-human technical test actor. Add no reviewer UI/evidence access, browser/server plaintext, server decryption, public/signed URL, production native binding, hosted migration, real data, deployment, closure, or external behavior.
