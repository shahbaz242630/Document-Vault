...
- Active branch: `codex/claimant-native-local-export`; Slice 4I is complete locally on top of Slice 4H `6077d66`, Slice 4G `83d1452`, Slice 4F `79a1d94`, Slice 4E `5122c6f`, Slice 4D `f0195fe`, Slice 4C `ef97a64`, Slice 4B `8d9d195`, and the earlier claimant checkpoints.
...
1. Begin Phase 4 Slice 4J with an immutable-false, unmounted retrieval-lifecycle closure foundation. Require exact completed authority and any separately verified export fact; preserve historical served/opened/export truth and record only administrative closure, never local deletion or recall.
2. Keep Slice 1G/1H/1I/1J/2A/2B/2C/2D/2E/2F/2G/2H/2I/2J/3A/3B/3C/3D/3E/3F/3G/4A/4B/4C/4D/4E/4F/4G/4H/4I hard-disabled and concealed, unmounted, or disconnected from normal app requests. Do not deploy the local claimant/Storage migrations or enable a claimant capability.
...
4. In Slice 4J, treat Shahbaz Malik as the accountable human test reviewer and Codex only as a non-human technical test actor. Add no reviewer UI/evidence access, browser/server plaintext, server decryption, public/signed URL, production native binding, hosted migration, real data, deployment, local deletion/recall claim, or external behavior.
