...
const expectedTables = [
  ...
  ["claimant_review_policies", []], ["claimant_review_prechecks", []],
...
function createCatalog() {
  const functions = [
    ...
    { functionName: "claimant_run_review_precheck", securityDefiner: false },
    { functionName: "claimant_record_single_approver_decision", securityDefiner: false },
    { functionName: "claimant_record_approval_notice_delivery", securityDefiner: false },
    { functionName: "claimant_hold_single_approval", securityDefiner: false },
    { functionName: "claimant_authorize_single_approver_release", securityDefiner: false },
    { functionName: "claimant_verify_review_audit_chain", securityDefiner: false },
    { functionName: "claimant_export_review_audit", securityDefiner: false },
    { functionName: "claimant_recipient_keys_current", securityDefiner: false },
    { functionName: "claimant_append_review_audit_entry", securityDefiner: false },
    { functionName: "claimant_enforce_review_round_mode", securityDefiner: false },
