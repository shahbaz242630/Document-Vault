...
const EXPECTED_AUTHENTICATED_PRIVILEGES = {
  ...
  claimant_app_attest_events: [], claimant_app_attest_keys: [],
  claimant_app_attest_challenges: [], claimant_case_device_keys: [],
  claimant_cases: [], claimant_device_keys: [],
  ...
  claimant_offline_code_v2_attempts: [], claimant_offline_code_v2_challenges: [], claimant_offline_code_v2_handoffs: [],
  claimant_offline_code_v2_events: [], claimant_offline_code_v2_idempotency: [],
  claimant_offline_code_v2_locators: [], claimant_offline_code_v2_rate_limits: [],
  claimant_outbox: [],
  ...
  claimant_review_resolution_authorities: [], claimant_review_policies: [], claimant_review_prechecks: [],
  claimant_single_approval_windows: [], claimant_single_approval_events: [],
  claimant_single_approval_idempotency: [], claimant_review_audit_chain: [],
...
const EXPECTED_SERVER_ONLY_FUNCTIONS = new Set([
  "claimant_accept_registered_invitation", "claimant_issue_registered_invitation",
  "claimant_activate_session", "claimant_assert_active_session",
  "claimant_revoke_session", "claimant_activate_portal_session",
  "claimant_assert_portal_session", "claimant_revoke_portal_session",
  "claimant_revoke_registered_invitation", "claimant_manage_registered_recipient",
  "bind_claimant_case_initial_key", "claimant_register_app_attest_key",
  "claimant_advance_app_attest_assertion", "claimant_issue_app_attest_registration_challenge",
  ...
  "claimant_begin_owner_notice", "claimant_bind_offline_code_v2_case", "claimant_offline_code_v2_handoff",
  "claimant_claim_owner_notice_delivery",
  "claimant_close_retrieval_lifecycle",
  "claimant_commit_encrypted_package_delivery",
  "claimant_complete_owner_notice_delivery",
  "claimant_complete_verified_native_open",
  ...
  "claimant_record_independent_review", "claimant_run_review_precheck",
  "claimant_record_single_approver_decision", "claimant_record_approval_notice_delivery",
  "claimant_hold_single_approval", "claimant_authorize_single_approver_release",
  "claimant_verify_review_audit_chain", "claimant_export_review_audit", "claimant_recipient_keys_current",
  "claimant_append_review_audit_entry", "claimant_enforce_review_round_mode",
  "claimant_record_offline_code_v2_attempt",
  "claimant_record_owner_notice_delivery",
...
module.exports = { CATALOG_SQL, analyzeCatalog, runSupabaseDbSecurityCheck };
