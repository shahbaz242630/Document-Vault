...
const { standaloneSchema: encryptedPackageSchema } =
...
function buildClaimantSignedManifestDbTestSql(options = {}) {
  ...
  const grants = [
    { id: id.grant1, key: id.key1, cipher: b64("synthetic sealed recipient grant 01"),
      nonce: b64("synthetic grant nonce 01"), ephemeral: b64("synthetic ephemeral public key 01") },
    { id: id.grant2, key: id.key2, cipher: b64("synthetic sealed recipient grant 02"),
      nonce: b64("synthetic grant nonce 02"), ephemeral: b64("synthetic ephemeral public key 02") },
  ];
  const common = { asset_ciphertext_digests: [sha256b64(Buffer.from(ciphertext, "base64url"))],
    asset_snapshot_boundary: "2026-08-18T09:59:00.000Z", cancellation_version: 1,
    claim_id: id.case, claim_version: 6, claimant_id: id.claimant,
    created_at: "2026-08-18T10:00:00.000Z", expires_at: "2026-08-21T10:00:00.000Z",
...
insert into public.vault_assets values ('${id.asset}', '${id.owner}', 'document',
  '${ciphertext}', '${assetNonce}', '2026-08-18T09:00:00Z',
  '2026-08-18T09:59:00Z', null);
insert into public.claimant_release_packages (id, package_ref, case_id,
  ...
  6, 1, 2, '2026-08-18T09:59:00Z', '${"a".repeat(64)}',
  '2026-08-18T10:00:00Z', '2026-08-21T10:00:00Z');
insert into public.claimant_release_package_assets values ('${id.package}', '${id.case}',
  1, '${id.asset}', 'document', '2026-08-18T09:59:00Z', '${ciphertext}',
  '${assetNonce}', encode(extensions.digest(concat_ws('|', '${id.asset}', 'document',
...
insert into public.claimant_release_package_grants values
  ('${id.package}', '${id.case}', 1, '${id.grant1}', 1, '${id.key1}', 1,
    ...
    'sanduqkin:claim:recipient-grant:v1', 'registered_recipient_v2', 'X25519',
    'HKDF-SHA256', 'XChaCha20-Poly1305', '${grants[0].ephemeral}', '${grants[0].nonce}',
  ...
  ('${id.package}', '${id.case}', 2, '${id.grant2}', 1, '${id.key2}', 1,
    ...
    'sanduqkin:claim:recipient-grant:v1', 'registered_recipient_v2', 'X25519',
    'HKDF-SHA256', 'XChaCha20-Poly1305', '${grants[1].ephemeral}', '${grants[1].nonce}',
